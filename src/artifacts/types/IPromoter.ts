...
export interface IPromoterInterface extends utils.Interface {
  contractName: "IPromoter";
  functions: {
...
export interface IPromoter extends BaseContract {
  contractName: "IPromoter";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPromoterInterface;
