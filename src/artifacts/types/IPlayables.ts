...
export interface IPlayablesInterface extends utils.Interface {
  contractName: "IPlayables";
  functions: {
...
export interface IPlayables extends BaseContract {
  contractName: "IPlayables";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPlayablesInterface;
