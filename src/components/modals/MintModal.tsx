...
export default function MintModal({ show, handleClose }: ModalProps) {
  const [steps, setSteps] = useState<{ [step: string]: any }>({ ...eventSteps });

  // const { wallet } = useContext(WalletContext);

  const handleError = (error: any, receipt: string) => {
