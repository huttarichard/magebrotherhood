  ...
  return (
    <PageLayout title="Privacy Policy" description="">
      <Main>
        ...
        <p>
          At MageBrotherhood, accessible from https://magebrotherhood.com, one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of information that is collected and recorded by
          MageBrotherhood and how we use it.
        </p>

        <p>
          If you have additional questions or require more information about our Privacy Policy, do not hesitate to
          contact us via discord or any other social media.
        </p>

        <p>
          This Privacy Policy applies only to our online activities and is valid for visitors to our website with
          regards to the information that they shared and/or collect in MageBrotherhood. This policy is not applicable
        ...
        <p>
          MageBrotherhood follows a standard procedure of using log files. These files log visitors when they visit
          websites. All hosting companies do this and a part of their analytics. The information collected by log files
        ...
        <p>
          Like any other website, MageBrotherhood uses cookies. These cookies are used to store information including
          visitors preferences, and the pages on the website that the visitor accessed or visited. The information is
          used to optimize the user experience by customizing our web page content based on visitors browser type and/or
          other information.
        </p>
        ...
        <p>
          You may consult this list to find the Privacy Policy for each of the advertising partners of MageBrotherhood.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
          in their respective advertisements and links that appear on MageBrotherhood, which are sent directly to users
        ...
        <p>
          Note that MageBrotherhood has no access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        ...
        <p>
          MageBrotherhoods Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>
          Request that a business that collects a consumers personal data disclose the categories and specific pieces of
        ...
        <p>
          MageBrotherhood does not knowingly collect any Personal Identifiable Information from children under the age
